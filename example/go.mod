module github.com/kitex-contrib/config-apollo/example

go 1.21.1

replace github.com/kitex-contrib/config-apollo => ../

require (
	github.com/cloudwego/kitex v0.7.2
	github.com/cloudwego/kitex-examples v0.2.0
	github.com/kitex-contrib/config-apollo v0.0.0-00010101000000-000000000000
)
